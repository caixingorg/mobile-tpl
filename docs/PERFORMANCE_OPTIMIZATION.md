...
| ---- | --------------------- | ------ | ---- | -------- |
| 1.1  | 修复倒计时内存泄漏    | @dev   | 🔴   | -        |
| 1.2  | 修复 Scroll 节流问题  | @dev   | 🔴   | -        |
| 1.3  | 关闭生产环境 Devtools | @dev   | 🔴   | -        |
| 1.4  | 添加 DNS 预解析       | @dev   | 🔴   | -        |
| 1.5  | HTML meta 标签优化    | @dev   | 🔴   | -        |

### Phase 2: 构建分析（Day 1-2 - 2 小时）

| 序号 | 任务                  | 负责人 | 状态 | 完成时间 |
| ---- | --------------------- | ------ | ---- | -------- |
| 2.1  | 添加 Bundle 分析工具  | @dev   | 🟡   | -        |
| 2.2  | 运行分析，识别大包    | @dev   | 🟡   | -        |
| 2.3  | 按需加载 Antd Mobile  | @dev   | 🟡   | -        |
| 2.4  | 启用 Gzip/Brotli 压缩 | @dev   | 🟡   | -        |
