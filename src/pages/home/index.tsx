/*
 * @Author: flynn * @Date: 2024-03-29 16:10:20
 * @LastEditors: flynn
  ...
  return (
    <DialogContext.Provider value={{}}>
      ...
      <div className={styles.root}>
        ...
        <button onClick={() => SET_TOKEN(token + '123')}>修改token</button>
        <button onClick={handleLogout}>重置</button>
        {/* <div>theme: {theme}</div> */}
        ...
        <div className={styles.card}>
          ...
          <button onClick={handleJumpLogin}>jumpLogin</button>
          <button onClick={() => navigate('/home2')}>jumpHome2</button>
